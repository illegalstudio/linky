                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <a href="{{ route('linky.admin.link.edit', $link)  }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    <form action="{{ route('linky.admin.link.destroy', $link) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
