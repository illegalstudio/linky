...
@section('content')
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <a href="{{ route('linky.admin.collection.create') }}" type="button"
                        ...
                        @foreach ($collections as $colection)
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="font-medium text-gray-900">{{ $colection->content->name }}</div>
                                </td>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <span
                                        class="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">{{ $colletion->content->status }}</span>
                                </td>
